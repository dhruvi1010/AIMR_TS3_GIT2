...
public class StretchHeadController : MonoBehaviour
{
    // --- ROS Connections ---
    ...
    public float tiltMin = -0.3f;  // -0.1f;  before
    ...
    void UpdateCameraFromHeadPose(Quaternion rawHeadRotation)
    {
        ...
        // --- Convert to Euler angles (kept for reference; just use direct quaternion math below) ---
