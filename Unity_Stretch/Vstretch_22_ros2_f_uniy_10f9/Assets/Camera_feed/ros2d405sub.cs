...
public class ros2d405sub : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            node = ros2Unity.CreateNode("unity_d405_subscriberr");

            // Determine if we're using compressed or raw images based on topic name
            ...
            else
            {
                ...
                QualityOfServiceProfile sensorQos = new QualityOfServiceProfile(QosPresetProfile.SENSOR_DATA);
                rawImageSub = node.CreateSubscription<sensor_msgs.msg.Image>(topicName, OnRawImage, sensorQos);
