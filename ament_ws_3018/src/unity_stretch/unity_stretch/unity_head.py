...
class UnityToStretchBridge(Node):
    def __init__(self):
        super().__init__('unity_stretch_head_bridge')
        ...
        self.get_logger().info('Unity-Stretch bridge started, waiting for action server...')
    ...
    def trajectory_callback(self, msg):
        ...
        self.get_logger().info(
            ...
            f'pan={msg.points[0].positions[0]:.3f} rad ({msg.points[0].positions[0]*57.3:.1f}°), '
            f'tilt={msg.points[0].positions[1]:.3f} rad ({msg.points[0].positions[1]*57.3:.1f}°)'
        )
